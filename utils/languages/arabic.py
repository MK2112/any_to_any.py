...
ARABIC = {
    ...
    "max_threads": "الحد الأقصى لعدد خيوط العمل المستخدمة لتحويل الملفات واحدًا تلو الآخر (الافتراضي: 1)",
    "preserve_meta": "الاحتفاظ بالبيانات الوصفية (علامات ID3 وEXIF وخصائص المستندات) في ملفات الإخراج",
    "add_tag": "إضافة علامات مخصصة إلى الملفات (التنسيق: key:value key2:value2)",
    "strip_meta": "إزالة جميع البيانات الوصفية من ملفات الإخراج (لحماية الخصوصية)",
    "resolution_help": "تغيير حجم مقاطع الفيديو إلى دقة محددة، مثل 1920x1080 أو 720p. تعتمد الدقات الصالحة على التنسيق؛ وعند رفض دقة معينة، يتم عرض الخيارات المتاحة.",
    "resolution_label": "الدقة",
    "resolution_original": "الاحتفاظ بالدقة الأصلية",
